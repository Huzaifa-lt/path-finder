  ...
  return (
    <table className=" w-full  ">
      ...
      <tr>
        <td>9/15/2020</td>
        <td>Present</td>
        <td>Flight Training International</td>
        <td>Professional Development</td>
        <td>C-32A Initial Qual Course, B757/767 Type</td>
        <td>
      ...
      <tr>
        ...
        <td>University - U.S. Accredited</td>
        <td>Masters of Arts in International Relations</td>
        <td>
          <div className=" flex justify-center">
            <button>
              <svg
      ...
      <tr>
        <td>9/15/2020</td>
        <td>9/15/2020</td>
        <td>14th Flying Training Wing</td>
        <td>U.S. Military Institution</td>
        <td>Specialized Undergraduate Pilot Training</td>
        <td>
          <div className=" flex justify-center">
            <button>
              <svg
      ...
      <tr>
        ...
        <td>University - U.S. Accredited</td>
        <td>BS in Business Admin & Accounting/Finance</td>
        <td>
          <div className=" flex justify-center">
            <button>
              <svg
      ...
      <tr>
        <td>9/15/2020</td>
        <td>9/15/2020</td>
        <td>Smoky Mountain High School</td>
        <td>High School - U.S.</td>
        <td>High School</td>
        <td>
          <div className=" flex justify-center">
            <button>
