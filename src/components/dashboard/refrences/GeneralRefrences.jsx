        ...
        <h4 className=" text-xl font-medium text-black  flex items-center gap-2">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent
                className=" bg-[#F4F5F9] border border-[#CBCBCB]"
                align="end"
              >
                NOTE: we recommend creating references specifically tailored to
                the company or companies you're looking to be hired by. We
                recommend using pilots from <br /> the specific airline you're
                looking to apply to. The summary above will help you keep track
                of what individual will be a reference for which company.
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </h4>
