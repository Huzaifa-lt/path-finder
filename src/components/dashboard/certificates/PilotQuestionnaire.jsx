    ...
    <>
      <p className=" mt-2 py-1.5 px-2 bg-[#FCF3EB] flex items-center gap-[5px] rounded-md text-[#DE7010] text-sm font-normal w-fit ">
        <span>
          ...
          >
            <g clipPath="url(#clip0_203_31645)">
              <path
      ...
      <div className=" mt-5 space-y-5">
        ...
        <RadioBox
          options={radioOptions}
          className=" flex gap-4"
          label=" 2. Have you ever been involved in an aircraft incident or accident
        ...
        <RadioBox
          options={radioOptions}
          className=" flex gap-4"
          label="   3. Have you ever been subject to a military flying evaluation board,
        ...
        <div className="p-4 space-y-4 border border-[#E7E9EB] rounded-xl">
          <RadioBox
            ...
            options={radioOptions}
            className="flex gap-4"
            label="  4. Have you ever been subject to any FAA enforcement action or
            investigation? *"
          />
          <div className="  w-2/12 ">
            <DatePicker label="Select date*" />
        ...
        <RadioBox
          options={radioOptions}
          className="flex gap-4"
          label="  5. Have you ever been removed from flight status, voluntarily or
        ...
        <RadioBox
          options={radioOptions}
          className="flex gap-4"
          label="  6. Do you have any other special aviation qualifications not
        ...
        <RadioBox
          options={radioOptions}
          className="flex gap-4"
          label=" 7. Regarding civilian flying experience, do you have at least 500
