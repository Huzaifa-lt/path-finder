...
const EmploymentTabs = ({ currentTab, onTabClick }) => {
  const tabs = [
    { name: "Employment Summary", id: "EmploymentSummary" },
    { name: "General", id: "EmploymentGeneral" },
    { name: "Current Employment", id: "CurrentEmployment" },
    { name: "Unemployment & Furlough History", id: "FurloughHistory" },
    { name: "Misc", id: "Misc" },
  ];
