    ...
    <div className="pt-6 px-6 pb-8 border border-[#E4E7EC] rounded-lg">
      <div>
        ...
        <p className=" mt-2 py-1.5 px-2 bg-[#FCF3EB] flex items-center gap-[5px] rounded-md text-[#DE7010] text-sm font-normal w-fit ">
          ...
          Please answer the following questions and provide details if
          necessary. Click the Save Changes button to record your information.
        </p>
      </div>
      ...
      <div className=" mt-5 space-y-5">
        ...
        />
        <TextArea
          label="Please list any professional organizations in which you are currently a member:*"
          placeholder="List organizations..."
        />
        <TextArea
          label="Please list any employment awards and achievements: *"
          placeholder="List awards & achievements..."
        />
        <TextArea
          label="Please list any volunteer / charity work: *"
          placeholder="List charity work..."
        />
      </div>
